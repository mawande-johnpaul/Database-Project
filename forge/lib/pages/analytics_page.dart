...
class AnalyticsPage extends StatefulWidget {
  AnalyticsPage({super.key, this.dataset, this.dataFile});
...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  void didChangeDependencies() {
    ...
    // Pull dataset/dataFile from the DatasetScope if not explicitly provided
    final scope = DatasetScope.of(context);
    if (scope != null) {
      if (widget.dataset == null && scope.dataset != null) {
        widget.dataset = scope.dataset;
      }
      if (widget.dataFile == null && scope.dataFile != null) {
        widget.dataFile = scope.dataFile;
      }
    }
    // Re-run load in case dataset was just provided
    _loadData();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: // First row of insight cards
      Column(
        children: [
          // Dataset Insights
          Text(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final emptyPercentage = data.isNotEmpty
                        ? (emptyCells / data.length * 100).toStringAsFixed(1)
                        : '0.0';
